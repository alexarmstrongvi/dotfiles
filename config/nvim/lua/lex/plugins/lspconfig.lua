...
return {
    ...
    { 'neovim/nvim-lspconfig',
        dependencies = {
            ...
            -- extra LSP capabilities (used below for auto-completion)
            'saghen/blink.cmp',
        ...
        config = function()
            vim.api.nvim_create_autocmd('LspAttach', {
                ...
                callback = function(event)
                    -- define mappings specific for LSP related items. It sets the 
                    -- mode, buffer and description for us each time.
            ...
            local servers = {
                ...
                clangd   = { -- C, C++
                    ...
                    -- utf-8 so must manually set this here
            ...
            require('mason-lspconfig').setup {
                ensure_installed = {}, -- explicitly set to an empty table (populating installs via mason-tool-installer)
